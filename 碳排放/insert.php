                ...
                <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <form action="registercheck.php" method="post">
                        <div class="row g-3">
                            ...
                            <div>
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="Password" placeholder="帳號" required>
                            ...
                            <div>
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="Phone" placeholder="密碼" required>
                                    <label for="電話">電話</label>
                                </div>
                            </div>
                            <div>
                                <div class="form-floating">
                                    <input type="email" class="form-control" name="Email" placeholder="密碼" required>
