        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">登入註冊</a>
                        <div class="dropdown-menu m-0">
                            <a href="登入.html" class="dropdown-item active">登入</a>
                                ...
                                <form action="registercheck.php" method="post">
                                    <div>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="ID" placeholder="姓名">
                                    ...
                                    <div>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" name="確認密碼" placeholder="確認密碼">
                                            <label for="確認密碼">確認密碼</label>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="form-floating">
                                            <input type="email" class="form-control" name="Email" placeholder="Email帳號">
                                            <label for="email">Email帳號</label>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="form-floating">
                                            <input type="number" class="form-control" name="Phone" placeholder="電話">
