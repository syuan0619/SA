                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="密碼" placeholder="密碼">
                                        <label for="密碼">密碼</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="確認密碼" placeholder="確認密碼">
                                        <label for="確認密碼">確認密碼</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="email" placeholder="Email帳號">
                                        <label for="email">Email帳號</label>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="phone" placeholder="電話">
